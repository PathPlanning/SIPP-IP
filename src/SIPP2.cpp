...
int end_x, end_y, end_v = 0, minimalTransitionCost = 0;
...
int main() {
    cout<<"SIPP2 started... map:"<<map<<endl;
    ofstream out;
    fillActions();
    ...
    for(int f = 0; f<factors.size(); ++f){
        ...
        out.open("../results/results SIPP2/res-" + map + "-SIPP2-obs"+to_string(num_of_obstacles)+".txt");
